...
public class OrderProcessing extends BaseInit {
	...
	public static void orderProcess()
		...
		// --Close the window
		Driver.findElement(By.className("ngdialog-close"));
		Thread.sleep(2000);
		...
		if (NoData.isDisplayed()) {
			...
			System.out.println("Data is present related search parameter");
			// --select 1st row
			Driver.findElement(By.xpath("//*[@class=\"dx-datagrid-content\"]//tr[1]/td")).click();
			boolean FstRow = Driver.findElement(By.xpath("//*[@class=\"dx-datagrid-content\"]//tr[1]/td")).isSelected();
			Assert.assertTrue(FstRow);
			Driver.findElement(By.xpath("//*[@class=\"dx-datagrid-content\"]//tr[2]/td")).click();
			boolean SndRow = Driver.findElement(By.xpath("//*[@class=\"dx-datagrid-content\"]//tr[2]/td")).isSelected();
			Assert.assertTrue(SndRow);
			// --Merge RTE
			Driver.findElement(By.id("btnMerge3")).click();
			wait.until(ExpectedConditions.invisibilityOfElementLocated(By.xpath("//*[@class=\"ajax-loadernew\"]")));
			wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.className("ngdialog-message")));
		...
		wait.until(ExpectedConditions.invisibilityOfElementLocated(By.xpath("//*[@class=\"ajax-loadernew\"]")));
		wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.id("GXNL")));
